...
public class RootWindow extends JFrame {
    ...
    private String[] suppliers = new String[]{"Saba", "Tom", "Jesus"};
    ...
    public RootWindow(String fileName) {
        ...
        submitButton.addActionListener(e -> {
            ...
            boolean condition = amountComboBox.getSelectedItem() != null && (amountComboBox.getSelectedItem().toString().matches("[^A-z]")) && ((Integer.parseInt(amountComboBox.getSelectedItem().toString()) >= 1 && Integer.parseInt(amountComboBox.getSelectedItem().toString()) <= 10)) && (Arrays.asList(suppliers).contains(supplierComboBox.getSelectedItem().toString()) || supplierComboBox.getSelectedItem().equals("Testy") || supplierComboBox.getSelectedItem().equals("Mctesterson"));
            if (condition) {
        ...
        submitOrderButton.addActionListener(e -> {
            ...
            if (singleTypePanel.isVisible() && !helper.checkSingleOrderAmount(singleWineKindBox.getSelectedItem().toString())) {
                ...
                if (customerNameField.getText().equals("Mıxed")) {
                    customer = "Mixed";
                } else {
